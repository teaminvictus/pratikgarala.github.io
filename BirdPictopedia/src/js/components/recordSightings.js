...
export default class RecordSightings extends React.Component {
    ...
    onSubmitAction(){
        ...
        console.log($("#basisOfRecord").val());
        console.log($("#birdName").val());
        console.log($("#certainity").val());
        ...
        if(this.props.postcodes.matchPostcodesForRecordSighting != 0 && this.props.birds.selectedPostcodeForRecordSighting == null){
                ...
                <div className="container">
                    <form action="#">
                        ...
                        <div className="row bottom_margin_20">
                            ...
                            <div className="col-lg-9">
                                <select name="certainity" id="certainity">
                        ...
                        <div className="row bottom_margin_20">
                            ...
                            <div className="col-lg-9">
                                <input type="text" id="location" placeholder="Enter Sighting Location..." onChange={() => {this.props.onDisplayPostcodeMatches()}} required autoComplete="off"/>
                        ...
                        <div className="row bottom_margin_20">
                            ...
                            <div className="col-lg-9">
                                <input type="number"  placeholder="Enter Bird Count..."  required/>
                            </div>
                        </div>
                        <div className="row bottom_margin_20">
                            <div className="col-lg-3 text-left">
                        ...
                        <div className="row bottom_margin_20">
                            ...
                            <div className="col-lg-4">
                                <input type="submit" value="Save" className="btn btn-default" onClick={()=>{this.onSubmitAction()}}/>
                            </div>
                            <div className="col-lg-4">
                            </div>
                        </div>
